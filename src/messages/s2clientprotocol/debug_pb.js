...
proto.SC2APIProtocol.DebugCommand.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      9,
      f,
      proto.SC2APIProtocol.DebugChat.serializeBinaryToWriter
    );
  }
};
...
proto.SC2APIProtocol.DebugCommand.prototype.getChat = function() {
  return /** @type{?proto.SC2APIProtocol.DebugChat} */ (
    jspb.Message.getWrapperField(this, proto.SC2APIProtocol.DebugChat, 9));
};
