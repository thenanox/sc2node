...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.SC2APIProtocol.RequestDebug.toObject = function (includeInstance, msg) {
        var f, obj = {
            debugList: jspb.Message.toObjectList(msg.getDebugList(), proto.SC2APIProtocol.DebugCommand.toObject, includeInstance)
        };
        if (includeInstance) {
...
proto.SC2APIProtocol.RequestDebug.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.SC2APIProtocol.DebugCommand.serializeBinaryToWriter);
    }
};
/**
...
proto.SC2APIProtocol.RequestDebug.prototype.getDebugList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.DebugCommand>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.DebugCommand, 1));
};
...
//# sourceMappingURL=requestdebug.js.map