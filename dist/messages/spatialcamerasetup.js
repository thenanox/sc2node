...
proto.SC2APIProtocol.SpatialCameraSetup.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(3, f, proto.SC2APIProtocol.Size2DI.serializeBinaryToWriter);
    }
};
/**
...
proto.SC2APIProtocol.SpatialCameraSetup.prototype.getMinimapResolution = function () {
    return /** @type{?proto.SC2APIProtocol.Size2DI} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.Size2DI, 3));
};
/** @param {?proto.SC2APIProtocol.Size2DI|undefined} value */
...
//# sourceMappingURL=spatialcamerasetup.js.map