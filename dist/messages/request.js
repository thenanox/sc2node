...
proto.SC2APIProtocol.Request.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getQuery();
    if (f != null) {
        writer.writeMessage(14, f, proto.SC2APIProtocol.RequestQuery.serializeBinaryToWriter);
    }
...
proto.SC2APIProtocol.Request.prototype.getQuery = function () {
    return /** @type{?proto.SC2APIProtocol.RequestQuery} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.RequestQuery, 14));
};
