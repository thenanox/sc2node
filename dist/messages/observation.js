...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.SC2APIProtocol.Observation.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            abilitiesList: jspb.Message.toObjectList(msg.getAbilitiesList(), proto.SC2APIProtocol.AvailableAbility.toObject, includeInstance),
...
proto.SC2APIProtocol.Observation.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(3, f, proto.SC2APIProtocol.AvailableAbility.serializeBinaryToWriter);
    }
    f = message.getScore();
    if (f != null) {
        writer.writeMessage(4, f, proto.SC2APIProtocol.Score.serializeBinaryToWriter);
    }
    f = message.getRawData();
    if (f != null) {
        writer.writeMessage(5, f, proto.SC2APIProtocol.ObservationRaw.serializeBinaryToWriter);
    }
    f = message.getFeatureLayerData();
    if (f != null) {
        writer.writeMessage(6, f, proto.SC2APIProtocol.ObservationFeatureLayer.serializeBinaryToWriter);
    }
    f = message.getRenderData();
    if (f != null) {
        writer.writeMessage(7, f, proto.SC2APIProtocol.ObservationRender.serializeBinaryToWriter);
    }
    f = message.getUiData();
    if (f != null) {
        writer.writeMessage(8, f, proto.SC2APIProtocol.ObservationUI.serializeBinaryToWriter);
    }
};
/**
...
proto.SC2APIProtocol.Observation.prototype.getAbilitiesList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.AvailableAbility>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.AvailableAbility, 3));
};
...
proto.SC2APIProtocol.Observation.prototype.getScore = function () {
    return /** @type{?proto.SC2APIProtocol.Score} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.Score, 4));
};
...
proto.SC2APIProtocol.Observation.prototype.getRawData = function () {
    return /** @type{?proto.SC2APIProtocol.ObservationRaw} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ObservationRaw, 5));
};
...
proto.SC2APIProtocol.Observation.prototype.getFeatureLayerData = function () {
    return /** @type{?proto.SC2APIProtocol.ObservationFeatureLayer} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ObservationFeatureLayer, 6));
};
...
proto.SC2APIProtocol.Observation.prototype.getRenderData = function () {
    return /** @type{?proto.SC2APIProtocol.ObservationRender} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ObservationRender, 7));
};
...
proto.SC2APIProtocol.Observation.prototype.getUiData = function () {
    return /** @type{?proto.SC2APIProtocol.ObservationUI} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ObservationUI, 8));
};
