...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.SC2APIProtocol.ResponseData.toObject = function (includeInstance, msg) {
        var f, obj = {
            abilitiesList: jspb.Message.toObjectList(msg.getAbilitiesList(), proto.SC2APIProtocol.AbilityData.toObject, includeInstance),
            unitsList: jspb.Message.toObjectList(msg.getUnitsList(), proto.SC2APIProtocol.UnitTypeData.toObject, includeInstance),
            upgradesList: jspb.Message.toObjectList(msg.getUpgradesList(), proto.SC2APIProtocol.UpgradeData.toObject, includeInstance),
            buffsList: jspb.Message.toObjectList(msg.getBuffsList(), proto.SC2APIProtocol.BuffData.toObject, includeInstance)
        };
        if (includeInstance) {
...
proto.SC2APIProtocol.ResponseData.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.SC2APIProtocol.AbilityData.serializeBinaryToWriter);
    }
    f = message.getUnitsList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(2, f, proto.SC2APIProtocol.UnitTypeData.serializeBinaryToWriter);
    }
    f = message.getUpgradesList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(3, f, proto.SC2APIProtocol.UpgradeData.serializeBinaryToWriter);
    }
    f = message.getBuffsList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(4, f, proto.SC2APIProtocol.BuffData.serializeBinaryToWriter);
    }
};
/**
...
proto.SC2APIProtocol.ResponseData.prototype.getAbilitiesList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.AbilityData>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.AbilityData, 1));
};
...
proto.SC2APIProtocol.ResponseData.prototype.getUnitsList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.UnitTypeData>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.UnitTypeData, 2));
};
...
proto.SC2APIProtocol.ResponseData.prototype.getUpgradesList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.UpgradeData>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.UpgradeData, 3));
};
...
proto.SC2APIProtocol.ResponseData.prototype.getBuffsList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.BuffData>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.BuffData, 4));
};
