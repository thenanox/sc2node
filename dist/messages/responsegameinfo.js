...
proto.SC2APIProtocol.ResponseGameInfo.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(4, f, proto.SC2APIProtocol.StartRaw.serializeBinaryToWriter);
    }
...
proto.SC2APIProtocol.ResponseGameInfo.prototype.getStartRaw = function () {
    return /** @type{?proto.SC2APIProtocol.StartRaw} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.StartRaw, 4));
};
...
//# sourceMappingURL=responsegameinfo.js.map