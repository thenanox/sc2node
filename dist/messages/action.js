...
proto.SC2APIProtocol.Action.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, proto.SC2APIProtocol.ActionRaw.serializeBinaryToWriter);
    }
    f = message.getActionFeatureLayer();
    if (f != null) {
        writer.writeMessage(2, f, proto.SC2APIProtocol.ActionSpatial.serializeBinaryToWriter);
    }
    f = message.getActionRender();
    if (f != null) {
        writer.writeMessage(3, f, proto.SC2APIProtocol.ActionSpatial.serializeBinaryToWriter);
    }
    f = message.getActionUi();
    if (f != null) {
        writer.writeMessage(4, f, proto.SC2APIProtocol.ActionUI.serializeBinaryToWriter);
    }
...
proto.SC2APIProtocol.Action.prototype.getActionRaw = function () {
    return /** @type{?proto.SC2APIProtocol.ActionRaw} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ActionRaw, 1));
};
...
proto.SC2APIProtocol.Action.prototype.getActionFeatureLayer = function () {
    return /** @type{?proto.SC2APIProtocol.ActionSpatial} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ActionSpatial, 2));
};
...
proto.SC2APIProtocol.Action.prototype.getActionRender = function () {
    return /** @type{?proto.SC2APIProtocol.ActionSpatial} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ActionSpatial, 3));
};
/** @param {?proto.SC2APIProtocol.ActionSpatial|undefined} value */
...
proto.SC2APIProtocol.Action.prototype.getActionUi = function () {
    return /** @type{?proto.SC2APIProtocol.ActionUI} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ActionUI, 4));
};
