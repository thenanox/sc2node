...
proto.SC2APIProtocol.Response.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getQuery();
    if (f != null) {
        writer.writeMessage(14, f, proto.SC2APIProtocol.ResponseQuery.serializeBinaryToWriter);
    }
...
proto.SC2APIProtocol.Response.prototype.getQuery = function () {
    return /** @type{?proto.SC2APIProtocol.ResponseQuery} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ResponseQuery, 14));
};
