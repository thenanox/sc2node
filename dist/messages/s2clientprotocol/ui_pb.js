...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.SC2APIProtocol.ObservationUI.toObject = function (includeInstance, msg) {
        var f, obj = {
            groupsList: jspb.Message.toObjectList(msg.getGroupsList(), proto.SC2APIProtocol.ControlGroup.toObject, includeInstance),
...
proto.SC2APIProtocol.ObservationUI.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.SC2APIProtocol.ControlGroup.serializeBinaryToWriter);
    }
    f = message.getSingle();
    if (f != null) {
        writer.writeMessage(2, f, proto.SC2APIProtocol.SinglePanel.serializeBinaryToWriter);
    }
    f = message.getMulti();
    if (f != null) {
        writer.writeMessage(3, f, proto.SC2APIProtocol.MultiPanel.serializeBinaryToWriter);
    }
    f = message.getCargo();
    if (f != null) {
        writer.writeMessage(4, f, proto.SC2APIProtocol.CargoPanel.serializeBinaryToWriter);
    }
    f = message.getProduction();
    if (f != null) {
        writer.writeMessage(5, f, proto.SC2APIProtocol.ProductionPanel.serializeBinaryToWriter);
    }
};
/**
...
proto.SC2APIProtocol.ObservationUI.prototype.getGroupsList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.ControlGroup>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.ControlGroup, 1));
};
...
proto.SC2APIProtocol.ObservationUI.prototype.getSingle = function () {
    return /** @type{?proto.SC2APIProtocol.SinglePanel} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.SinglePanel, 2));
};
...
proto.SC2APIProtocol.ObservationUI.prototype.getMulti = function () {
    return /** @type{?proto.SC2APIProtocol.MultiPanel} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.MultiPanel, 3));
};
...
proto.SC2APIProtocol.ObservationUI.prototype.getCargo = function () {
    return /** @type{?proto.SC2APIProtocol.CargoPanel} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.CargoPanel, 4));
};
...
proto.SC2APIProtocol.ObservationUI.prototype.getProduction = function () {
    return /** @type{?proto.SC2APIProtocol.ProductionPanel} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ProductionPanel, 5));
};
...
proto.SC2APIProtocol.UnitInfo.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getAddOn();
    if (f != null) {
        writer.writeMessage(8, f, proto.SC2APIProtocol.UnitInfo.serializeBinaryToWriter);
    }
};
/**
...
proto.SC2APIProtocol.UnitInfo.prototype.getAddOn = function () {
    return /** @type{?proto.SC2APIProtocol.UnitInfo} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.UnitInfo, 8));
};
...
proto.SC2APIProtocol.SinglePanel.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getUnit();
    if (f != null) {
        writer.writeMessage(1, f, proto.SC2APIProtocol.UnitInfo.serializeBinaryToWriter);
    }
};
/**
...
proto.SC2APIProtocol.SinglePanel.prototype.getUnit = function () {
    return /** @type{?proto.SC2APIProtocol.UnitInfo} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.UnitInfo, 1));
};
/** @param {?proto.SC2APIProtocol.UnitInfo|undefined} value */
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.SC2APIProtocol.MultiPanel.toObject = function (includeInstance, msg) {
        var f, obj = {
            unitsList: jspb.Message.toObjectList(msg.getUnitsList(), proto.SC2APIProtocol.UnitInfo.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.SC2APIProtocol.MultiPanel.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.SC2APIProtocol.UnitInfo.serializeBinaryToWriter);
    }
};
/**
...
proto.SC2APIProtocol.MultiPanel.prototype.getUnitsList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.UnitInfo>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.UnitInfo, 1));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.SC2APIProtocol.CargoPanel.toObject = function (includeInstance, msg) {
        var f, obj = {
            unit: (f = msg.getUnit()) && proto.SC2APIProtocol.UnitInfo.toObject(includeInstance, f),
            passengersList: jspb.Message.toObjectList(msg.getPassengersList(), proto.SC2APIProtocol.UnitInfo.toObject, includeInstance),
...
proto.SC2APIProtocol.CargoPanel.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(2, f, proto.SC2APIProtocol.UnitInfo.serializeBinaryToWriter);
    }
    f = /** @type {number} */ (jspb.Message.getField(message, 3));
    if (f != null) {
        writer.writeInt32(3, f);
...
proto.SC2APIProtocol.CargoPanel.prototype.getPassengersList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.UnitInfo>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.UnitInfo, 2));
};
/** @param {!Array.<!proto.SC2APIProtocol.UnitInfo>} value */
 ...
 * @const
 */
proto.SC2APIProtocol.ProductionPanel.repeatedFields_ = [2];
if (jspb.Message.GENERATE_TO_OBJECT) {
    /**
     * Creates an object representation of this proto suitable for use in Soy templates.
     * Field names that are reserved in JavaScript and will be renamed to pb_name.
    ...
    proto.SC2APIProtocol.ProductionPanel.toObject = function (includeInstance, msg) {
        var f, obj = {
            unit: (f = msg.getUnit()) && proto.SC2APIProtocol.UnitInfo.toObject(includeInstance, f),
            buildQueueList: jspb.Message.toObjectList(msg.getBuildQueueList(), proto.SC2APIProtocol.UnitInfo.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.SC2APIProtocol.ActionUI.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, proto.SC2APIProtocol.ActionControlGroup.serializeBinaryToWriter);
    }
    f = message.getSelectArmy();
    if (f != null) {
        writer.writeMessage(2, f, proto.SC2APIProtocol.ActionSelectArmy.serializeBinaryToWriter);
    }
    f = message.getSelectWarpGates();
    if (f != null) {
        writer.writeMessage(3, f, proto.SC2APIProtocol.ActionSelectWarpGates.serializeBinaryToWriter);
    }
    f = message.getSelectLarva();
    if (f != null) {
        writer.writeMessage(4, f, proto.SC2APIProtocol.ActionSelectLarva.serializeBinaryToWriter);
    }
    f = message.getSelectIdleWorker();
    if (f != null) {
        writer.writeMessage(5, f, proto.SC2APIProtocol.ActionSelectIdleWorker.serializeBinaryToWriter);
    }
    f = message.getMultiPanel();
    if (f != null) {
        writer.writeMessage(6, f, proto.SC2APIProtocol.ActionMultiPanel.serializeBinaryToWriter);
    }
    f = message.getCargoPanel();
    if (f != null) {
        writer.writeMessage(7, f, proto.SC2APIProtocol.ActionCargoPanelUnload.serializeBinaryToWriter);
    }
    f = message.getProductionPanel();
    if (f != null) {
        writer.writeMessage(8, f, proto.SC2APIProtocol.ActionProductionPanelRemoveFromQueue.serializeBinaryToWriter);
    }
    f = message.getToggleAutocast();
    if (f != null) {
        writer.writeMessage(9, f, proto.SC2APIProtocol.ActionToggleAutocast.serializeBinaryToWriter);
    }
};
/**
...
proto.SC2APIProtocol.ActionUI.prototype.getControlGroup = function () {
    return /** @type{?proto.SC2APIProtocol.ActionControlGroup} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ActionControlGroup, 1));
};
...
proto.SC2APIProtocol.ActionUI.prototype.getSelectArmy = function () {
    return /** @type{?proto.SC2APIProtocol.ActionSelectArmy} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ActionSelectArmy, 2));
};
...
proto.SC2APIProtocol.ActionUI.prototype.getSelectWarpGates = function () {
    return /** @type{?proto.SC2APIProtocol.ActionSelectWarpGates} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ActionSelectWarpGates, 3));
};
...
proto.SC2APIProtocol.ActionUI.prototype.getSelectLarva = function () {
    return /** @type{?proto.SC2APIProtocol.ActionSelectLarva} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ActionSelectLarva, 4));
};
...
proto.SC2APIProtocol.ActionUI.prototype.getSelectIdleWorker = function () {
    return /** @type{?proto.SC2APIProtocol.ActionSelectIdleWorker} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ActionSelectIdleWorker, 5));
};
...
proto.SC2APIProtocol.ActionUI.prototype.getMultiPanel = function () {
    return /** @type{?proto.SC2APIProtocol.ActionMultiPanel} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ActionMultiPanel, 6));
};
...
proto.SC2APIProtocol.ActionUI.prototype.getCargoPanel = function () {
    return /** @type{?proto.SC2APIProtocol.ActionCargoPanelUnload} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ActionCargoPanelUnload, 7));
};
...
proto.SC2APIProtocol.ActionUI.prototype.getProductionPanel = function () {
    return /** @type{?proto.SC2APIProtocol.ActionProductionPanelRemoveFromQueue} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ActionProductionPanelRemoveFromQueue, 8));
};
...
proto.SC2APIProtocol.ActionUI.prototype.getToggleAutocast = function () {
    return /** @type{?proto.SC2APIProtocol.ActionToggleAutocast} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ActionToggleAutocast, 9));
};
