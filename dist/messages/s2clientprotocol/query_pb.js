...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.SC2APIProtocol.RequestQuery.toObject = function (includeInstance, msg) {
        var f, obj = {
            pathingList: jspb.Message.toObjectList(msg.getPathingList(), proto.SC2APIProtocol.RequestQueryPathing.toObject, includeInstance),
            abilitiesList: jspb.Message.toObjectList(msg.getAbilitiesList(), proto.SC2APIProtocol.RequestQueryAvailableAbilities.toObject, includeInstance),
            placementsList: jspb.Message.toObjectList(msg.getPlacementsList(), proto.SC2APIProtocol.RequestQueryBuildingPlacement.toObject, includeInstance),
...
proto.SC2APIProtocol.RequestQuery.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.SC2APIProtocol.RequestQueryPathing.serializeBinaryToWriter);
    }
    f = message.getAbilitiesList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(2, f, proto.SC2APIProtocol.RequestQueryAvailableAbilities.serializeBinaryToWriter);
    }
    f = message.getPlacementsList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(3, f, proto.SC2APIProtocol.RequestQueryBuildingPlacement.serializeBinaryToWriter);
    }
...
proto.SC2APIProtocol.RequestQuery.prototype.getPathingList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.RequestQueryPathing>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.RequestQueryPathing, 1));
};
...
proto.SC2APIProtocol.RequestQuery.prototype.getAbilitiesList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.RequestQueryAvailableAbilities>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.RequestQueryAvailableAbilities, 2));
};
...
proto.SC2APIProtocol.RequestQuery.prototype.getPlacementsList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.RequestQueryBuildingPlacement>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.RequestQueryBuildingPlacement, 3));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.SC2APIProtocol.ResponseQuery.toObject = function (includeInstance, msg) {
        var f, obj = {
            pathingList: jspb.Message.toObjectList(msg.getPathingList(), proto.SC2APIProtocol.ResponseQueryPathing.toObject, includeInstance),
            abilitiesList: jspb.Message.toObjectList(msg.getAbilitiesList(), proto.SC2APIProtocol.ResponseQueryAvailableAbilities.toObject, includeInstance),
            placementsList: jspb.Message.toObjectList(msg.getPlacementsList(), proto.SC2APIProtocol.ResponseQueryBuildingPlacement.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.SC2APIProtocol.ResponseQuery.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getPathingList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.SC2APIProtocol.ResponseQueryPathing.serializeBinaryToWriter);
    }
    f = message.getAbilitiesList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(2, f, proto.SC2APIProtocol.ResponseQueryAvailableAbilities.serializeBinaryToWriter);
    }
    f = message.getPlacementsList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(3, f, proto.SC2APIProtocol.ResponseQueryBuildingPlacement.serializeBinaryToWriter);
    }
};
/**
...
proto.SC2APIProtocol.ResponseQuery.prototype.getPathingList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.ResponseQueryPathing>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.ResponseQueryPathing, 1));
};
...
proto.SC2APIProtocol.ResponseQuery.prototype.getAbilitiesList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.ResponseQueryAvailableAbilities>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.ResponseQueryAvailableAbilities, 2));
};
...
proto.SC2APIProtocol.ResponseQuery.prototype.getPlacementsList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.ResponseQueryBuildingPlacement>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.ResponseQueryBuildingPlacement, 3));
};
...
proto.SC2APIProtocol.RequestQueryPathing.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, s2clientprotocol_common_pb.Point2D.serializeBinaryToWriter);
    }
...
proto.SC2APIProtocol.RequestQueryPathing.prototype.getStartPos = function () {
    return /** @type{?proto.SC2APIProtocol.Point2D} */ (jspb.Message.getWrapperField(this, s2clientprotocol_common_pb.Point2D, 1));
};
...
proto.SC2APIProtocol.ResponseQueryAvailableAbilities.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getAbilitiesList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, s2clientprotocol_common_pb.AvailableAbility.serializeBinaryToWriter);
    }
    f = /** @type {number} */ (jspb.Message.getField(message, 2));
    if (f != null) {
        writer.writeUint64(2, f);
...
proto.SC2APIProtocol.ResponseQueryAvailableAbilities.prototype.getAbilitiesList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.AvailableAbility>} */ (jspb.Message.getRepeatedWrapperField(this, s2clientprotocol_common_pb.AvailableAbility, 1));
};
