...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.SC2APIProtocol.Weapon.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            damageBonusList: jspb.Message.toObjectList(msg.getDamageBonusList(), proto.SC2APIProtocol.DamageBonus.toObject, includeInstance),
...
proto.SC2APIProtocol.Weapon.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(3, f, proto.SC2APIProtocol.DamageBonus.serializeBinaryToWriter);
    }
...
proto.SC2APIProtocol.Weapon.prototype.getDamageBonusList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.DamageBonus>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.DamageBonus, 3));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.SC2APIProtocol.UnitTypeData.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            weaponsList: jspb.Message.toObjectList(msg.getWeaponsList(), proto.SC2APIProtocol.Weapon.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.SC2APIProtocol.UnitTypeData.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedUint32(21, f);
    }
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(11, f, proto.SC2APIProtocol.Weapon.serializeBinaryToWriter);
    }
};
/**
...
proto.SC2APIProtocol.UnitTypeData.prototype.getWeaponsList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.Weapon>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.Weapon, 11));
};
