...
proto.SC2APIProtocol.ImageData.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getSize();
    if (f != null) {
        writer.writeMessage(2, f, proto.SC2APIProtocol.Size2DI.serializeBinaryToWriter);
    }
...
proto.SC2APIProtocol.ImageData.prototype.getSize = function () {
    return /** @type{?proto.SC2APIProtocol.Size2DI} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.Size2DI, 2));
};
...
proto.SC2APIProtocol.RectangleI.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getP0();
    if (f != null) {
        writer.writeMessage(1, f, proto.SC2APIProtocol.PointI.serializeBinaryToWriter);
    }
    f = message.getP1();
    if (f != null) {
        writer.writeMessage(2, f, proto.SC2APIProtocol.PointI.serializeBinaryToWriter);
    }
};
/**
...
proto.SC2APIProtocol.RectangleI.prototype.getP0 = function () {
    return /** @type{?proto.SC2APIProtocol.PointI} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.PointI, 1));
};
...
proto.SC2APIProtocol.RectangleI.prototype.getP1 = function () {
    return /** @type{?proto.SC2APIProtocol.PointI} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.PointI, 2));
};
/** @param {?proto.SC2APIProtocol.PointI|undefined} value */
