...
goog.exportSymbol('proto.SC2APIProtocol.DebugChat', null, global);
 ...
 * @const
 */
proto.SC2APIProtocol.DebugCommand.oneofGroups_ = [[1, 2, 3, 4, 5, 6, 7, 8, 9]];
/**
 * @enum {number}
 */
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.SC2APIProtocol.DebugCommand.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            chat: (f = msg.getChat()) && proto.SC2APIProtocol.DebugChat.toObject(includeInstance, f)
        };
        if (includeInstance) {
    ...
    while (reader.nextField()) {
        ...
        switch (field) {
            ...
            case 8:
                ...
                break;
            case 9:
                var value = new proto.SC2APIProtocol.DebugChat;
                reader.readMessage(value, proto.SC2APIProtocol.DebugChat.deserializeBinaryFromReader);
                msg.setChat(value);
                break;
            default:
                reader.skipField();
...
proto.SC2APIProtocol.DebugCommand.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getDraw();
    if (f != null) {
        writer.writeMessage(1, f, proto.SC2APIProtocol.DebugDraw.serializeBinaryToWriter);
    }
    ...
    if (f != null) {
        writer.writeMessage(3, f, proto.SC2APIProtocol.DebugCreateUnit.serializeBinaryToWriter);
    }
    f = message.getKillUnit();
    if (f != null) {
        writer.writeMessage(4, f, proto.SC2APIProtocol.DebugKillUnit.serializeBinaryToWriter);
    }
    f = message.getTestProcess();
    if (f != null) {
        writer.writeMessage(5, f, proto.SC2APIProtocol.DebugTestProcess.serializeBinaryToWriter);
    }
    f = message.getScore();
    if (f != null) {
        writer.writeMessage(6, f, proto.SC2APIProtocol.DebugSetScore.serializeBinaryToWriter);
    }
    f = message.getEndGame();
    if (f != null) {
        writer.writeMessage(7, f, proto.SC2APIProtocol.DebugEndGame.serializeBinaryToWriter);
    }
    f = message.getUnitValue();
    if (f != null) {
        writer.writeMessage(8, f, proto.SC2APIProtocol.DebugSetUnitValue.serializeBinaryToWriter);
    }
    f = message.getChat();
    if (f != null) {
        writer.writeMessage(9, f, proto.SC2APIProtocol.DebugChat.serializeBinaryToWriter);
    }
};
/**
...
proto.SC2APIProtocol.DebugCommand.prototype.getDraw = function () {
    return /** @type{?proto.SC2APIProtocol.DebugDraw} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.DebugDraw, 1));
};
...
proto.SC2APIProtocol.DebugCommand.prototype.getCreateUnit = function () {
    return /** @type{?proto.SC2APIProtocol.DebugCreateUnit} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.DebugCreateUnit, 3));
};
...
proto.SC2APIProtocol.DebugCommand.prototype.getKillUnit = function () {
    return /** @type{?proto.SC2APIProtocol.DebugKillUnit} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.DebugKillUnit, 4));
};
...
proto.SC2APIProtocol.DebugCommand.prototype.getTestProcess = function () {
    return /** @type{?proto.SC2APIProtocol.DebugTestProcess} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.DebugTestProcess, 5));
};
...
proto.SC2APIProtocol.DebugCommand.prototype.getScore = function () {
    return /** @type{?proto.SC2APIProtocol.DebugSetScore} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.DebugSetScore, 6));
};
...
proto.SC2APIProtocol.DebugCommand.prototype.getEndGame = function () {
    return /** @type{?proto.SC2APIProtocol.DebugEndGame} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.DebugEndGame, 7));
};
...
proto.SC2APIProtocol.DebugCommand.prototype.getUnitValue = function () {
    return /** @type{?proto.SC2APIProtocol.DebugSetUnitValue} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.DebugSetUnitValue, 8));
};
...
/**
 * optional DebugChat chat = 9;
 * @return {?proto.SC2APIProtocol.DebugChat}
 */
proto.SC2APIProtocol.DebugCommand.prototype.getChat = function () {
    return /** @type{?proto.SC2APIProtocol.DebugChat} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.DebugChat, 9));
};
/** @param {?proto.SC2APIProtocol.DebugChat|undefined} value */
proto.SC2APIProtocol.DebugCommand.prototype.setChat = function (value) {
    jspb.Message.setOneofWrapperField(this, 9, proto.SC2APIProtocol.DebugCommand.oneofGroups_[0], value);
};
proto.SC2APIProtocol.DebugCommand.prototype.clearChat = function () {
 ...
 * @return {!boolean}
 */
proto.SC2APIProtocol.DebugCommand.prototype.hasChat = function () {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.SC2APIProtocol.DebugDraw.toObject = function (includeInstance, msg) {
        var f, obj = {
            textList: jspb.Message.toObjectList(msg.getTextList(), proto.SC2APIProtocol.DebugText.toObject, includeInstance),
            linesList: jspb.Message.toObjectList(msg.getLinesList(), proto.SC2APIProtocol.DebugLine.toObject, includeInstance),
            boxesList: jspb.Message.toObjectList(msg.getBoxesList(), proto.SC2APIProtocol.DebugBox.toObject, includeInstance),
            spheresList: jspb.Message.toObjectList(msg.getSpheresList(), proto.SC2APIProtocol.DebugSphere.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.SC2APIProtocol.DebugDraw.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.SC2APIProtocol.DebugText.serializeBinaryToWriter);
    }
    f = message.getLinesList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(2, f, proto.SC2APIProtocol.DebugLine.serializeBinaryToWriter);
    }
    f = message.getBoxesList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(3, f, proto.SC2APIProtocol.DebugBox.serializeBinaryToWriter);
    }
    f = message.getSpheresList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(4, f, proto.SC2APIProtocol.DebugSphere.serializeBinaryToWriter);
    }
};
/**
...
proto.SC2APIProtocol.DebugDraw.prototype.getTextList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.DebugText>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.DebugText, 1));
};
...
proto.SC2APIProtocol.DebugDraw.prototype.getLinesList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.DebugLine>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.DebugLine, 2));
};
...
proto.SC2APIProtocol.DebugDraw.prototype.getBoxesList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.DebugBox>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.DebugBox, 3));
};
...
proto.SC2APIProtocol.DebugDraw.prototype.getSpheresList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.DebugSphere>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.DebugSphere, 4));
};
...
proto.SC2APIProtocol.Line.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getP0();
    if (f != null) {
        writer.writeMessage(1, f, s2clientprotocol_common_pb.Point.serializeBinaryToWriter);
    }
    f = message.getP1();
    if (f != null) {
        writer.writeMessage(2, f, s2clientprotocol_common_pb.Point.serializeBinaryToWriter);
    }
};
/**
 * optional Point p0 = 1;
...
proto.SC2APIProtocol.Line.prototype.getP0 = function () {
    return /** @type{?proto.SC2APIProtocol.Point} */ (jspb.Message.getWrapperField(this, s2clientprotocol_common_pb.Point, 1));
};
...
proto.SC2APIProtocol.Line.prototype.getP1 = function () {
    return /** @type{?proto.SC2APIProtocol.Point} */ (jspb.Message.getWrapperField(this, s2clientprotocol_common_pb.Point, 2));
};
/** @param {?proto.SC2APIProtocol.Point|undefined} value */
...
proto.SC2APIProtocol.DebugText.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getColor();
    if (f != null) {
        writer.writeMessage(1, f, proto.SC2APIProtocol.Color.serializeBinaryToWriter);
    }
    ...
    if (f != null) {
        writer.writeMessage(3, f, s2clientprotocol_common_pb.Point.serializeBinaryToWriter);
    }
    f = message.getWorldPos();
    if (f != null) {
        writer.writeMessage(4, f, s2clientprotocol_common_pb.Point.serializeBinaryToWriter);
    }
};
/**
...
proto.SC2APIProtocol.DebugText.prototype.getColor = function () {
    return /** @type{?proto.SC2APIProtocol.Color} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.Color, 1));
};
...
proto.SC2APIProtocol.DebugText.prototype.getVirtualPos = function () {
    return /** @type{?proto.SC2APIProtocol.Point} */ (jspb.Message.getWrapperField(this, s2clientprotocol_common_pb.Point, 3));
};
/** @param {?proto.SC2APIProtocol.Point|undefined} value */
...
proto.SC2APIProtocol.DebugText.prototype.getWorldPos = function () {
    return /** @type{?proto.SC2APIProtocol.Point} */ (jspb.Message.getWrapperField(this, s2clientprotocol_common_pb.Point, 4));
};
/** @param {?proto.SC2APIProtocol.Point|undefined} value */
...
proto.SC2APIProtocol.DebugLine.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getLine();
    if (f != null) {
        writer.writeMessage(2, f, proto.SC2APIProtocol.Line.serializeBinaryToWriter);
    }
};
/**
 * optional Color color = 1;
...
proto.SC2APIProtocol.DebugLine.prototype.getLine = function () {
    return /** @type{?proto.SC2APIProtocol.Line} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.Line, 2));
};
...
proto.SC2APIProtocol.DebugCreateUnit.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getPos();
    if (f != null) {
        writer.writeMessage(3, f, s2clientprotocol_common_pb.Point2D.serializeBinaryToWriter);
    }
...
proto.SC2APIProtocol.DebugCreateUnit.prototype.getPos = function () {
    return /** @type{?proto.SC2APIProtocol.Point2D} */ (jspb.Message.getWrapperField(this, s2clientprotocol_common_pb.Point2D, 3));
};
...
proto.SC2APIProtocol.DebugKillUnit.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedUint64(1, f);
    }
};
/**
 ...
 * @constructor
 */
proto.SC2APIProtocol.DebugChat = function (opt_data) {
    jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.SC2APIProtocol.DebugChat, jspb.Message);
if (goog.DEBUG && !COMPILED) {
    proto.SC2APIProtocol.DebugChat.displayName = 'proto.SC2APIProtocol.DebugChat';
}
if (jspb.Message.GENERATE_TO_OBJECT) {
    /**
     * Creates an object representation of this proto suitable for use in Soy templates.
     ...
     * @return {!Object}
     */
    proto.SC2APIProtocol.DebugChat.prototype.toObject = function (opt_includeInstance) {
        return proto.SC2APIProtocol.DebugChat.toObject(opt_includeInstance, this);
    };
    /**
     * Static version of the {@see toObject} method.
     * @param {boolean|undefined} includeInstance Whether to include the JSPB
     *     instance for transitional soy proto support:
     *     http://goto/soy-param-migration
     * @param {!proto.SC2APIProtocol.DebugChat} msg The msg instance to transform.
     * @return {!Object}
     * @suppress {unusedLocalVariables} f is only used for nested messages
     */
    proto.SC2APIProtocol.DebugChat.toObject = function (includeInstance, msg) {
        var f, obj = {
 ...
 * @return {!proto.SC2APIProtocol.DebugChat}
 */
proto.SC2APIProtocol.DebugChat.deserializeBinary = function (bytes) {
    var reader = new jspb.BinaryReader(bytes);
    var msg = new proto.SC2APIProtocol.DebugChat;
    return proto.SC2APIProtocol.DebugChat.deserializeBinaryFromReader(msg, reader);
};
/**
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.SC2APIProtocol.DebugChat} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.SC2APIProtocol.DebugChat}
 */
proto.SC2APIProtocol.DebugChat.deserializeBinaryFromReader = function (msg, reader) {
    while (reader.nextField()) {
        if (reader.isEndGroup()) {
            break;
        }
 ...
 * @return {!Uint8Array}
 */
proto.SC2APIProtocol.DebugChat.prototype.serializeBinary = function () {
    var writer = new jspb.BinaryWriter();
    proto.SC2APIProtocol.DebugChat.serializeBinaryToWriter(this, writer);
    return writer.getResultBuffer();
};
/**
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.SC2APIProtocol.DebugChat} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.SC2APIProtocol.DebugChat.serializeBinaryToWriter = function (message, writer) {
    var f = undefined;
 ...
 * @return {string}
 */
proto.SC2APIProtocol.DebugChat.prototype.getMessage = function () {
    return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
/** @param {string} value */
proto.SC2APIProtocol.DebugChat.prototype.setMessage = function (value) {
    jspb.Message.setField(this, 1, value);
};
proto.SC2APIProtocol.DebugChat.prototype.clearMessage = function () {
    jspb.Message.setField(this, 1, undefined);
};
/**
 * Returns whether this field is set.
 * @return {!boolean}
 */
proto.SC2APIProtocol.DebugChat.prototype.hasMessage = function () {
    return jspb.Message.getField(this, 1) != null;
};
/**
 * @enum {number}
...
//# sourceMappingURL=debug_pb.js.map