...
var s2clientprotocol_data_pb = require('../s2clientprotocol/data_pb.js');
var s2clientprotocol_debug_pb = require('../s2clientprotocol/debug_pb.js');
var s2clientprotocol_error_pb = require('../s2clientprotocol/error_pb.js');
var s2clientprotocol_query_pb = require('../s2clientprotocol/query_pb.js');
var s2clientprotocol_raw_pb = require('../s2clientprotocol/raw_pb.js');
var s2clientprotocol_score_pb = require('../s2clientprotocol/score_pb.js');
var s2clientprotocol_spatial_pb = require('../s2clientprotocol/spatial_pb.js');
var s2clientprotocol_ui_pb = require('../s2clientprotocol/ui_pb.js');
...
proto.SC2APIProtocol.Request.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, proto.SC2APIProtocol.RequestCreateGame.serializeBinaryToWriter);
    }
    f = message.getJoinGame();
    if (f != null) {
        writer.writeMessage(2, f, proto.SC2APIProtocol.RequestJoinGame.serializeBinaryToWriter);
    }
    f = message.getRestartGame();
    if (f != null) {
        writer.writeMessage(3, f, proto.SC2APIProtocol.RequestRestartGame.serializeBinaryToWriter);
    }
    f = message.getStartReplay();
    if (f != null) {
        writer.writeMessage(4, f, proto.SC2APIProtocol.RequestStartReplay.serializeBinaryToWriter);
    }
    f = message.getLeaveGame();
    if (f != null) {
        writer.writeMessage(5, f, proto.SC2APIProtocol.RequestLeaveGame.serializeBinaryToWriter);
    }
    f = message.getQuickSave();
    if (f != null) {
        writer.writeMessage(6, f, proto.SC2APIProtocol.RequestQuickSave.serializeBinaryToWriter);
    }
    f = message.getQuickLoad();
    if (f != null) {
        writer.writeMessage(7, f, proto.SC2APIProtocol.RequestQuickLoad.serializeBinaryToWriter);
    }
    f = message.getQuit();
    if (f != null) {
        writer.writeMessage(8, f, proto.SC2APIProtocol.RequestQuit.serializeBinaryToWriter);
    }
    f = message.getGameInfo();
    if (f != null) {
        writer.writeMessage(9, f, proto.SC2APIProtocol.RequestGameInfo.serializeBinaryToWriter);
    }
    f = message.getObservation();
    if (f != null) {
        writer.writeMessage(10, f, proto.SC2APIProtocol.RequestObservation.serializeBinaryToWriter);
    }
    f = message.getAction();
    if (f != null) {
        writer.writeMessage(11, f, proto.SC2APIProtocol.RequestAction.serializeBinaryToWriter);
    }
    f = message.getStep();
    if (f != null) {
        writer.writeMessage(12, f, proto.SC2APIProtocol.RequestStep.serializeBinaryToWriter);
    }
    f = message.getData();
    if (f != null) {
        writer.writeMessage(13, f, proto.SC2APIProtocol.RequestData.serializeBinaryToWriter);
    }
    f = message.getQuery();
    if (f != null) {
        writer.writeMessage(14, f, s2clientprotocol_query_pb.RequestQuery.serializeBinaryToWriter);
    }
    f = message.getSaveReplay();
    if (f != null) {
        writer.writeMessage(15, f, proto.SC2APIProtocol.RequestSaveReplay.serializeBinaryToWriter);
    }
    f = message.getReplayInfo();
    if (f != null) {
        writer.writeMessage(16, f, proto.SC2APIProtocol.RequestReplayInfo.serializeBinaryToWriter);
    }
    f = message.getAvailableMaps();
    if (f != null) {
        writer.writeMessage(17, f, proto.SC2APIProtocol.RequestAvailableMaps.serializeBinaryToWriter);
    }
    f = message.getSaveMap();
    if (f != null) {
        writer.writeMessage(18, f, proto.SC2APIProtocol.RequestSaveMap.serializeBinaryToWriter);
    }
    f = message.getPing();
    if (f != null) {
        writer.writeMessage(19, f, proto.SC2APIProtocol.RequestPing.serializeBinaryToWriter);
    }
    f = message.getDebug();
    if (f != null) {
        writer.writeMessage(20, f, proto.SC2APIProtocol.RequestDebug.serializeBinaryToWriter);
    }
};
/**
...
proto.SC2APIProtocol.Request.prototype.getCreateGame = function () {
    return /** @type{?proto.SC2APIProtocol.RequestCreateGame} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.RequestCreateGame, 1));
};
...
proto.SC2APIProtocol.Request.prototype.getJoinGame = function () {
    return /** @type{?proto.SC2APIProtocol.RequestJoinGame} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.RequestJoinGame, 2));
};
...
proto.SC2APIProtocol.Request.prototype.getRestartGame = function () {
    return /** @type{?proto.SC2APIProtocol.RequestRestartGame} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.RequestRestartGame, 3));
};
...
proto.SC2APIProtocol.Request.prototype.getStartReplay = function () {
    return /** @type{?proto.SC2APIProtocol.RequestStartReplay} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.RequestStartReplay, 4));
};
...
proto.SC2APIProtocol.Request.prototype.getLeaveGame = function () {
    return /** @type{?proto.SC2APIProtocol.RequestLeaveGame} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.RequestLeaveGame, 5));
};
...
proto.SC2APIProtocol.Request.prototype.getQuickSave = function () {
    return /** @type{?proto.SC2APIProtocol.RequestQuickSave} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.RequestQuickSave, 6));
};
...
proto.SC2APIProtocol.Request.prototype.getQuickLoad = function () {
    return /** @type{?proto.SC2APIProtocol.RequestQuickLoad} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.RequestQuickLoad, 7));
};
...
proto.SC2APIProtocol.Request.prototype.getQuit = function () {
    return /** @type{?proto.SC2APIProtocol.RequestQuit} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.RequestQuit, 8));
};
...
proto.SC2APIProtocol.Request.prototype.getGameInfo = function () {
    return /** @type{?proto.SC2APIProtocol.RequestGameInfo} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.RequestGameInfo, 9));
};
...
proto.SC2APIProtocol.Request.prototype.getObservation = function () {
    return /** @type{?proto.SC2APIProtocol.RequestObservation} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.RequestObservation, 10));
};
...
proto.SC2APIProtocol.Request.prototype.getAction = function () {
    return /** @type{?proto.SC2APIProtocol.RequestAction} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.RequestAction, 11));
};
...
proto.SC2APIProtocol.Request.prototype.getStep = function () {
    return /** @type{?proto.SC2APIProtocol.RequestStep} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.RequestStep, 12));
};
...
proto.SC2APIProtocol.Request.prototype.getData = function () {
    return /** @type{?proto.SC2APIProtocol.RequestData} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.RequestData, 13));
};
...
proto.SC2APIProtocol.Request.prototype.getQuery = function () {
    return /** @type{?proto.SC2APIProtocol.RequestQuery} */ (jspb.Message.getWrapperField(this, s2clientprotocol_query_pb.RequestQuery, 14));
};
...
proto.SC2APIProtocol.Request.prototype.getSaveReplay = function () {
    return /** @type{?proto.SC2APIProtocol.RequestSaveReplay} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.RequestSaveReplay, 15));
};
...
proto.SC2APIProtocol.Request.prototype.getReplayInfo = function () {
    return /** @type{?proto.SC2APIProtocol.RequestReplayInfo} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.RequestReplayInfo, 16));
};
...
proto.SC2APIProtocol.Request.prototype.getAvailableMaps = function () {
    return /** @type{?proto.SC2APIProtocol.RequestAvailableMaps} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.RequestAvailableMaps, 17));
};
...
proto.SC2APIProtocol.Request.prototype.getSaveMap = function () {
    return /** @type{?proto.SC2APIProtocol.RequestSaveMap} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.RequestSaveMap, 18));
};
...
proto.SC2APIProtocol.Request.prototype.getPing = function () {
    return /** @type{?proto.SC2APIProtocol.RequestPing} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.RequestPing, 19));
};
...
proto.SC2APIProtocol.Request.prototype.getDebug = function () {
    return /** @type{?proto.SC2APIProtocol.RequestDebug} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.RequestDebug, 20));
};
...
proto.SC2APIProtocol.Response.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getCreateGame();
    if (f != null) {
        writer.writeMessage(1, f, proto.SC2APIProtocol.ResponseCreateGame.serializeBinaryToWriter);
    }
    f = message.getJoinGame();
    if (f != null) {
        writer.writeMessage(2, f, proto.SC2APIProtocol.ResponseJoinGame.serializeBinaryToWriter);
    }
    f = message.getRestartGame();
    if (f != null) {
        writer.writeMessage(3, f, proto.SC2APIProtocol.ResponseRestartGame.serializeBinaryToWriter);
    }
    f = message.getStartReplay();
    if (f != null) {
        writer.writeMessage(4, f, proto.SC2APIProtocol.ResponseStartReplay.serializeBinaryToWriter);
    }
    f = message.getLeaveGame();
    if (f != null) {
        writer.writeMessage(5, f, proto.SC2APIProtocol.ResponseLeaveGame.serializeBinaryToWriter);
    }
    f = message.getQuickSave();
    if (f != null) {
        writer.writeMessage(6, f, proto.SC2APIProtocol.ResponseQuickSave.serializeBinaryToWriter);
    }
    f = message.getQuickLoad();
    if (f != null) {
        writer.writeMessage(7, f, proto.SC2APIProtocol.ResponseQuickLoad.serializeBinaryToWriter);
    }
    f = message.getQuit();
    if (f != null) {
        writer.writeMessage(8, f, proto.SC2APIProtocol.ResponseQuit.serializeBinaryToWriter);
    }
    f = message.getGameInfo();
    if (f != null) {
        writer.writeMessage(9, f, proto.SC2APIProtocol.ResponseGameInfo.serializeBinaryToWriter);
    }
    f = message.getObservation();
    if (f != null) {
        writer.writeMessage(10, f, proto.SC2APIProtocol.ResponseObservation.serializeBinaryToWriter);
    }
    f = message.getAction();
    if (f != null) {
        writer.writeMessage(11, f, proto.SC2APIProtocol.ResponseAction.serializeBinaryToWriter);
    }
    f = message.getStep();
    if (f != null) {
        writer.writeMessage(12, f, proto.SC2APIProtocol.ResponseStep.serializeBinaryToWriter);
    }
    f = message.getData();
    if (f != null) {
        writer.writeMessage(13, f, proto.SC2APIProtocol.ResponseData.serializeBinaryToWriter);
    }
    f = message.getQuery();
    if (f != null) {
        writer.writeMessage(14, f, s2clientprotocol_query_pb.ResponseQuery.serializeBinaryToWriter);
    }
    f = message.getSaveReplay();
    if (f != null) {
        writer.writeMessage(15, f, proto.SC2APIProtocol.ResponseSaveReplay.serializeBinaryToWriter);
    }
    f = message.getReplayInfo();
    if (f != null) {
        writer.writeMessage(16, f, proto.SC2APIProtocol.ResponseReplayInfo.serializeBinaryToWriter);
    }
    f = message.getAvailableMaps();
    if (f != null) {
        writer.writeMessage(17, f, proto.SC2APIProtocol.ResponseAvailableMaps.serializeBinaryToWriter);
    }
    f = message.getSaveMap();
    if (f != null) {
        writer.writeMessage(18, f, proto.SC2APIProtocol.ResponseSaveMap.serializeBinaryToWriter);
    }
    f = message.getPing();
    if (f != null) {
        writer.writeMessage(19, f, proto.SC2APIProtocol.ResponsePing.serializeBinaryToWriter);
    }
    f = message.getDebug();
    if (f != null) {
        writer.writeMessage(20, f, proto.SC2APIProtocol.ResponseDebug.serializeBinaryToWriter);
    }
    f = message.getErrorList();
    if (f.length > 0) {
        writer.writeRepeatedString(98, f);
    }
    f = /** @type {!proto.SC2APIProtocol.Status} */ (jspb.Message.getField(message, 99));
    if (f != null) {
        writer.writeEnum(99, f);
    }
};
/**
...
proto.SC2APIProtocol.Response.prototype.getCreateGame = function () {
    return /** @type{?proto.SC2APIProtocol.ResponseCreateGame} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ResponseCreateGame, 1));
};
...
proto.SC2APIProtocol.Response.prototype.getJoinGame = function () {
    return /** @type{?proto.SC2APIProtocol.ResponseJoinGame} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ResponseJoinGame, 2));
};
...
proto.SC2APIProtocol.Response.prototype.getRestartGame = function () {
    return /** @type{?proto.SC2APIProtocol.ResponseRestartGame} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ResponseRestartGame, 3));
};
...
proto.SC2APIProtocol.Response.prototype.getStartReplay = function () {
    return /** @type{?proto.SC2APIProtocol.ResponseStartReplay} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ResponseStartReplay, 4));
};
...
proto.SC2APIProtocol.Response.prototype.getLeaveGame = function () {
    return /** @type{?proto.SC2APIProtocol.ResponseLeaveGame} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ResponseLeaveGame, 5));
};
...
proto.SC2APIProtocol.Response.prototype.getQuickSave = function () {
    return /** @type{?proto.SC2APIProtocol.ResponseQuickSave} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ResponseQuickSave, 6));
};
...
proto.SC2APIProtocol.Response.prototype.getQuickLoad = function () {
    return /** @type{?proto.SC2APIProtocol.ResponseQuickLoad} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ResponseQuickLoad, 7));
};
...
proto.SC2APIProtocol.Response.prototype.getQuit = function () {
    return /** @type{?proto.SC2APIProtocol.ResponseQuit} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ResponseQuit, 8));
};
...
proto.SC2APIProtocol.Response.prototype.getGameInfo = function () {
    return /** @type{?proto.SC2APIProtocol.ResponseGameInfo} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ResponseGameInfo, 9));
};
...
proto.SC2APIProtocol.Response.prototype.getObservation = function () {
    return /** @type{?proto.SC2APIProtocol.ResponseObservation} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ResponseObservation, 10));
};
...
proto.SC2APIProtocol.Response.prototype.getAction = function () {
    return /** @type{?proto.SC2APIProtocol.ResponseAction} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ResponseAction, 11));
};
...
proto.SC2APIProtocol.Response.prototype.getStep = function () {
    return /** @type{?proto.SC2APIProtocol.ResponseStep} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ResponseStep, 12));
};
...
proto.SC2APIProtocol.Response.prototype.getData = function () {
    return /** @type{?proto.SC2APIProtocol.ResponseData} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ResponseData, 13));
};
...
proto.SC2APIProtocol.Response.prototype.getQuery = function () {
    return /** @type{?proto.SC2APIProtocol.ResponseQuery} */ (jspb.Message.getWrapperField(this, s2clientprotocol_query_pb.ResponseQuery, 14));
};
...
proto.SC2APIProtocol.Response.prototype.getSaveReplay = function () {
    return /** @type{?proto.SC2APIProtocol.ResponseSaveReplay} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ResponseSaveReplay, 15));
};
...
proto.SC2APIProtocol.Response.prototype.getReplayInfo = function () {
    return /** @type{?proto.SC2APIProtocol.ResponseReplayInfo} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ResponseReplayInfo, 16));
};
...
proto.SC2APIProtocol.Response.prototype.getAvailableMaps = function () {
    return /** @type{?proto.SC2APIProtocol.ResponseAvailableMaps} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ResponseAvailableMaps, 17));
};
...
proto.SC2APIProtocol.Response.prototype.getSaveMap = function () {
    return /** @type{?proto.SC2APIProtocol.ResponseSaveMap} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ResponseSaveMap, 18));
};
...
proto.SC2APIProtocol.Response.prototype.getPing = function () {
    return /** @type{?proto.SC2APIProtocol.ResponsePing} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ResponsePing, 19));
};
...
proto.SC2APIProtocol.Response.prototype.getDebug = function () {
    return /** @type{?proto.SC2APIProtocol.ResponseDebug} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ResponseDebug, 20));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.SC2APIProtocol.RequestCreateGame.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            playerSetupList: jspb.Message.toObjectList(msg.getPlayerSetupList(), proto.SC2APIProtocol.PlayerSetup.toObject, includeInstance),
...
proto.SC2APIProtocol.RequestCreateGame.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, proto.SC2APIProtocol.LocalMap.serializeBinaryToWriter);
    }
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(3, f, proto.SC2APIProtocol.PlayerSetup.serializeBinaryToWriter);
    }
...
proto.SC2APIProtocol.RequestCreateGame.prototype.getLocalMap = function () {
    return /** @type{?proto.SC2APIProtocol.LocalMap} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.LocalMap, 1));
};
...
proto.SC2APIProtocol.RequestCreateGame.prototype.getPlayerSetupList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.PlayerSetup>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.PlayerSetup, 3));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.SC2APIProtocol.RequestJoinGame.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            clientPortsList: jspb.Message.toObjectList(msg.getClientPortsList(), proto.SC2APIProtocol.PortSet.toObject, includeInstance),
...
proto.SC2APIProtocol.RequestJoinGame.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(4, f, proto.SC2APIProtocol.PortSet.serializeBinaryToWriter);
    }
    f = message.getClientPortsList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(5, f, proto.SC2APIProtocol.PortSet.serializeBinaryToWriter);
    }
...
proto.SC2APIProtocol.RequestJoinGame.prototype.getServerPorts = function () {
    return /** @type{?proto.SC2APIProtocol.PortSet} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.PortSet, 4));
};
...
proto.SC2APIProtocol.RequestJoinGame.prototype.getClientPortsList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.PortSet>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.PortSet, 5));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.SC2APIProtocol.ResponseGameInfo.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            playerInfoList: jspb.Message.toObjectList(msg.getPlayerInfoList(), proto.SC2APIProtocol.PlayerInfo.toObject, includeInstance),
...
proto.SC2APIProtocol.ResponseGameInfo.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(3, f, proto.SC2APIProtocol.PlayerInfo.serializeBinaryToWriter);
    }
    f = message.getStartRaw();
    if (f != null) {
        writer.writeMessage(4, f, s2clientprotocol_raw_pb.StartRaw.serializeBinaryToWriter);
    }
    f = message.getOptions();
    if (f != null) {
        writer.writeMessage(5, f, proto.SC2APIProtocol.InterfaceOptions.serializeBinaryToWriter);
    }
};
/**
...
proto.SC2APIProtocol.ResponseGameInfo.prototype.getPlayerInfoList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.PlayerInfo>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.PlayerInfo, 3));
};
...
proto.SC2APIProtocol.ResponseGameInfo.prototype.getStartRaw = function () {
    return /** @type{?proto.SC2APIProtocol.StartRaw} */ (jspb.Message.getWrapperField(this, s2clientprotocol_raw_pb.StartRaw, 4));
};
...
proto.SC2APIProtocol.ResponseGameInfo.prototype.getOptions = function () {
    return /** @type{?proto.SC2APIProtocol.InterfaceOptions} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.InterfaceOptions, 5));
};
/** @param {?proto.SC2APIProtocol.InterfaceOptions|undefined} value */
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.SC2APIProtocol.ResponseObservation.toObject = function (includeInstance, msg) {
        var f, obj = {
            actionsList: jspb.Message.toObjectList(msg.getActionsList(), proto.SC2APIProtocol.Action.toObject, includeInstance),
            actionErrorsList: jspb.Message.toObjectList(msg.getActionErrorsList(), proto.SC2APIProtocol.ActionError.toObject, includeInstance),
            observation: (f = msg.getObservation()) && proto.SC2APIProtocol.Observation.toObject(includeInstance, f),
            playerResultList: jspb.Message.toObjectList(msg.getPlayerResultList(), proto.SC2APIProtocol.PlayerResult.toObject, includeInstance),
            chatList: jspb.Message.toObjectList(msg.getChatList(), proto.SC2APIProtocol.ChatReceived.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.SC2APIProtocol.ResponseObservation.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.SC2APIProtocol.Action.serializeBinaryToWriter);
    }
    f = message.getActionErrorsList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(2, f, proto.SC2APIProtocol.ActionError.serializeBinaryToWriter);
    }
    f = message.getObservation();
    if (f != null) {
        writer.writeMessage(3, f, proto.SC2APIProtocol.Observation.serializeBinaryToWriter);
    }
    f = message.getPlayerResultList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(4, f, proto.SC2APIProtocol.PlayerResult.serializeBinaryToWriter);
    }
    f = message.getChatList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(5, f, proto.SC2APIProtocol.ChatReceived.serializeBinaryToWriter);
    }
};
/**
...
proto.SC2APIProtocol.ResponseObservation.prototype.getActionsList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.Action>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.Action, 1));
};
...
proto.SC2APIProtocol.ResponseObservation.prototype.getActionErrorsList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.ActionError>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.ActionError, 2));
};
...
proto.SC2APIProtocol.ResponseObservation.prototype.getObservation = function () {
    return /** @type{?proto.SC2APIProtocol.Observation} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.Observation, 3));
};
...
proto.SC2APIProtocol.ResponseObservation.prototype.getPlayerResultList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.PlayerResult>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.PlayerResult, 4));
};
...
proto.SC2APIProtocol.ResponseObservation.prototype.getChatList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.ChatReceived>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.ChatReceived, 5));
};
 ...
 * @const
 */
proto.SC2APIProtocol.ResponseData.repeatedFields_ = [1, 2, 3, 4];
if (jspb.Message.GENERATE_TO_OBJECT) {
    /**
     * Creates an object representation of this proto suitable for use in Soy templates.
     * Field names that are reserved in JavaScript and will be renamed to pb_name.
    ...
    proto.SC2APIProtocol.ResponseData.toObject = function (includeInstance, msg) {
        var f, obj = {
            abilitiesList: jspb.Message.toObjectList(msg.getAbilitiesList(), s2clientprotocol_data_pb.AbilityData.toObject, includeInstance),
            unitsList: jspb.Message.toObjectList(msg.getUnitsList(), s2clientprotocol_data_pb.UnitTypeData.toObject, includeInstance),
            upgradesList: jspb.Message.toObjectList(msg.getUpgradesList(), s2clientprotocol_data_pb.UpgradeData.toObject, includeInstance),
            buffsList: jspb.Message.toObjectList(msg.getBuffsList(), s2clientprotocol_data_pb.BuffData.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.SC2APIProtocol.ResponseData.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, s2clientprotocol_data_pb.AbilityData.serializeBinaryToWriter);
    }
    f = message.getUnitsList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(2, f, s2clientprotocol_data_pb.UnitTypeData.serializeBinaryToWriter);
    }
    f = message.getUpgradesList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(3, f, s2clientprotocol_data_pb.UpgradeData.serializeBinaryToWriter);
    }
    f = message.getBuffsList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(4, f, s2clientprotocol_data_pb.BuffData.serializeBinaryToWriter);
    }
};
/**
...
proto.SC2APIProtocol.ResponseData.prototype.getAbilitiesList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.AbilityData>} */ (jspb.Message.getRepeatedWrapperField(this, s2clientprotocol_data_pb.AbilityData, 1));
};
...
proto.SC2APIProtocol.ResponseData.prototype.getUnitsList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.UnitTypeData>} */ (jspb.Message.getRepeatedWrapperField(this, s2clientprotocol_data_pb.UnitTypeData, 2));
};
...
proto.SC2APIProtocol.ResponseData.prototype.getUpgradesList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.UpgradeData>} */ (jspb.Message.getRepeatedWrapperField(this, s2clientprotocol_data_pb.UpgradeData, 3));
};
...
proto.SC2APIProtocol.ResponseData.prototype.getBuffsList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.BuffData>} */ (jspb.Message.getRepeatedWrapperField(this, s2clientprotocol_data_pb.BuffData, 4));
};
...
proto.SC2APIProtocol.PlayerInfoExtra.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, proto.SC2APIProtocol.PlayerInfo.serializeBinaryToWriter);
    }
    f = message.getPlayerResult();
    if (f != null) {
        writer.writeMessage(2, f, proto.SC2APIProtocol.PlayerResult.serializeBinaryToWriter);
    }
...
proto.SC2APIProtocol.PlayerInfoExtra.prototype.getPlayerInfo = function () {
    return /** @type{?proto.SC2APIProtocol.PlayerInfo} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.PlayerInfo, 1));
};
...
proto.SC2APIProtocol.PlayerInfoExtra.prototype.getPlayerResult = function () {
    return /** @type{?proto.SC2APIProtocol.PlayerResult} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.PlayerResult, 2));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.SC2APIProtocol.ResponseReplayInfo.toObject = function (includeInstance, msg) {
        var f, obj = {
            mapName: jspb.Message.getField(msg, 1),
            localMapPath: jspb.Message.getField(msg, 2),
            playerInfoList: jspb.Message.toObjectList(msg.getPlayerInfoList(), proto.SC2APIProtocol.PlayerInfoExtra.toObject, includeInstance),
...
proto.SC2APIProtocol.ResponseReplayInfo.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getPlayerInfoList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(3, f, proto.SC2APIProtocol.PlayerInfoExtra.serializeBinaryToWriter);
    }
    f = /** @type {number} */ (jspb.Message.getField(message, 4));
    if (f != null) {
...
proto.SC2APIProtocol.ResponseReplayInfo.prototype.getPlayerInfoList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.PlayerInfoExtra>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.PlayerInfoExtra, 3));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.SC2APIProtocol.RequestDebug.toObject = function (includeInstance, msg) {
        var f, obj = {
            debugList: jspb.Message.toObjectList(msg.getDebugList(), s2clientprotocol_debug_pb.DebugCommand.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.SC2APIProtocol.RequestDebug.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, s2clientprotocol_debug_pb.DebugCommand.serializeBinaryToWriter);
    }
};
/**
...
proto.SC2APIProtocol.RequestDebug.prototype.getDebugList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.DebugCommand>} */ (jspb.Message.getRepeatedWrapperField(this, s2clientprotocol_debug_pb.DebugCommand, 1));
};
...
proto.SC2APIProtocol.SpatialCameraSetup.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(2, f, s2clientprotocol_common_pb.Size2DI.serializeBinaryToWriter);
    }
    f = message.getMinimapResolution();
    if (f != null) {
        writer.writeMessage(3, f, s2clientprotocol_common_pb.Size2DI.serializeBinaryToWriter);
    }
};
/**
...
proto.SC2APIProtocol.SpatialCameraSetup.prototype.getResolution = function () {
    return /** @type{?proto.SC2APIProtocol.Size2DI} */ (jspb.Message.getWrapperField(this, s2clientprotocol_common_pb.Size2DI, 2));
};
...
proto.SC2APIProtocol.SpatialCameraSetup.prototype.getMinimapResolution = function () {
    return /** @type{?proto.SC2APIProtocol.Size2DI} */ (jspb.Message.getWrapperField(this, s2clientprotocol_common_pb.Size2DI, 3));
};
/** @param {?proto.SC2APIProtocol.Size2DI|undefined} value */
...
proto.SC2APIProtocol.InterfaceOptions.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(3, f, proto.SC2APIProtocol.SpatialCameraSetup.serializeBinaryToWriter);
    }
    f = message.getRender();
    if (f != null) {
        writer.writeMessage(4, f, proto.SC2APIProtocol.SpatialCameraSetup.serializeBinaryToWriter);
    }
};
/**
 * optional bool raw = 1;
...
proto.SC2APIProtocol.InterfaceOptions.prototype.getFeatureLayer = function () {
    return /** @type{?proto.SC2APIProtocol.SpatialCameraSetup} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.SpatialCameraSetup, 3));
};
...
proto.SC2APIProtocol.InterfaceOptions.prototype.getRender = function () {
    return /** @type{?proto.SC2APIProtocol.SpatialCameraSetup} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.SpatialCameraSetup, 4));
};
/** @param {?proto.SC2APIProtocol.SpatialCameraSetup|undefined} value */
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.SC2APIProtocol.Observation.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            abilitiesList: jspb.Message.toObjectList(msg.getAbilitiesList(), s2clientprotocol_common_pb.AvailableAbility.toObject, includeInstance),
...
proto.SC2APIProtocol.Observation.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, proto.SC2APIProtocol.PlayerCommon.serializeBinaryToWriter);
    }
    f = message.getAlertsList();
    if (f.length > 0) {
        writer.writeRepeatedEnum(10, f);
    }
    f = message.getAbilitiesList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(3, f, s2clientprotocol_common_pb.AvailableAbility.serializeBinaryToWriter);
    }
    f = message.getScore();
    if (f != null) {
        writer.writeMessage(4, f, s2clientprotocol_score_pb.Score.serializeBinaryToWriter);
    }
    f = message.getRawData();
    if (f != null) {
        writer.writeMessage(5, f, s2clientprotocol_raw_pb.ObservationRaw.serializeBinaryToWriter);
    }
    f = message.getFeatureLayerData();
    if (f != null) {
        writer.writeMessage(6, f, s2clientprotocol_spatial_pb.ObservationFeatureLayer.serializeBinaryToWriter);
    }
    f = message.getRenderData();
    if (f != null) {
        writer.writeMessage(7, f, s2clientprotocol_spatial_pb.ObservationRender.serializeBinaryToWriter);
    }
    f = message.getUiData();
    if (f != null) {
        writer.writeMessage(8, f, s2clientprotocol_ui_pb.ObservationUI.serializeBinaryToWriter);
    }
};
/**
...
proto.SC2APIProtocol.Observation.prototype.getPlayerCommon = function () {
    return /** @type{?proto.SC2APIProtocol.PlayerCommon} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.PlayerCommon, 1));
};
...
proto.SC2APIProtocol.Observation.prototype.getAbilitiesList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.AvailableAbility>} */ (jspb.Message.getRepeatedWrapperField(this, s2clientprotocol_common_pb.AvailableAbility, 3));
};
...
proto.SC2APIProtocol.Observation.prototype.getScore = function () {
    return /** @type{?proto.SC2APIProtocol.Score} */ (jspb.Message.getWrapperField(this, s2clientprotocol_score_pb.Score, 4));
};
...
proto.SC2APIProtocol.Observation.prototype.getRawData = function () {
    return /** @type{?proto.SC2APIProtocol.ObservationRaw} */ (jspb.Message.getWrapperField(this, s2clientprotocol_raw_pb.ObservationRaw, 5));
};
...
proto.SC2APIProtocol.Observation.prototype.getFeatureLayerData = function () {
    return /** @type{?proto.SC2APIProtocol.ObservationFeatureLayer} */ (jspb.Message.getWrapperField(this, s2clientprotocol_spatial_pb.ObservationFeatureLayer, 6));
};
...
proto.SC2APIProtocol.Observation.prototype.getRenderData = function () {
    return /** @type{?proto.SC2APIProtocol.ObservationRender} */ (jspb.Message.getWrapperField(this, s2clientprotocol_spatial_pb.ObservationRender, 7));
};
...
proto.SC2APIProtocol.Observation.prototype.getUiData = function () {
    return /** @type{?proto.SC2APIProtocol.ObservationUI} */ (jspb.Message.getWrapperField(this, s2clientprotocol_ui_pb.ObservationUI, 8));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.SC2APIProtocol.Action.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            chatList: jspb.Message.toObjectList(msg.getChatList(), proto.SC2APIProtocol.ActionChat.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.SC2APIProtocol.Action.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, s2clientprotocol_raw_pb.ActionRaw.serializeBinaryToWriter);
    }
    f = message.getActionFeatureLayer();
    if (f != null) {
        writer.writeMessage(2, f, s2clientprotocol_spatial_pb.ActionSpatial.serializeBinaryToWriter);
    }
    f = message.getActionRender();
    if (f != null) {
        writer.writeMessage(3, f, s2clientprotocol_spatial_pb.ActionSpatial.serializeBinaryToWriter);
    }
    f = message.getActionUi();
    if (f != null) {
        writer.writeMessage(4, f, s2clientprotocol_ui_pb.ActionUI.serializeBinaryToWriter);
    }
    f = message.getChatList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(5, f, proto.SC2APIProtocol.ActionChat.serializeBinaryToWriter);
    }
};
/**
...
proto.SC2APIProtocol.Action.prototype.getActionRaw = function () {
    return /** @type{?proto.SC2APIProtocol.ActionRaw} */ (jspb.Message.getWrapperField(this, s2clientprotocol_raw_pb.ActionRaw, 1));
};
...
proto.SC2APIProtocol.Action.prototype.getActionFeatureLayer = function () {
    return /** @type{?proto.SC2APIProtocol.ActionSpatial} */ (jspb.Message.getWrapperField(this, s2clientprotocol_spatial_pb.ActionSpatial, 2));
};
...
proto.SC2APIProtocol.Action.prototype.getActionRender = function () {
    return /** @type{?proto.SC2APIProtocol.ActionSpatial} */ (jspb.Message.getWrapperField(this, s2clientprotocol_spatial_pb.ActionSpatial, 3));
};
/** @param {?proto.SC2APIProtocol.ActionSpatial|undefined} value */
...
proto.SC2APIProtocol.Action.prototype.getActionUi = function () {
    return /** @type{?proto.SC2APIProtocol.ActionUI} */ (jspb.Message.getWrapperField(this, s2clientprotocol_ui_pb.ActionUI, 4));
};
...
proto.SC2APIProtocol.Action.prototype.getChatList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.ActionChat>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.ActionChat, 5));
};
...
//# sourceMappingURL=sc2api_pb.js.map