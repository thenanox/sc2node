...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.SC2APIProtocol.StartRaw.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            startLocationsList: jspb.Message.toObjectList(msg.getStartLocationsList(), s2clientprotocol_common_pb.Point2D.toObject, includeInstance)
        };
        if (includeInstance) {
...
proto.SC2APIProtocol.StartRaw.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, s2clientprotocol_common_pb.Size2DI.serializeBinaryToWriter);
    }
    f = message.getPathingGrid();
    if (f != null) {
        writer.writeMessage(2, f, s2clientprotocol_common_pb.ImageData.serializeBinaryToWriter);
    }
    f = message.getTerrainHeight();
    if (f != null) {
        writer.writeMessage(3, f, s2clientprotocol_common_pb.ImageData.serializeBinaryToWriter);
    }
    f = message.getPlacementGrid();
    if (f != null) {
        writer.writeMessage(4, f, s2clientprotocol_common_pb.ImageData.serializeBinaryToWriter);
    }
    f = message.getPlayableArea();
    if (f != null) {
        writer.writeMessage(5, f, s2clientprotocol_common_pb.RectangleI.serializeBinaryToWriter);
    }
    f = message.getStartLocationsList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(6, f, s2clientprotocol_common_pb.Point2D.serializeBinaryToWriter);
    }
};
/**
...
proto.SC2APIProtocol.StartRaw.prototype.getMapSize = function () {
    return /** @type{?proto.SC2APIProtocol.Size2DI} */ (jspb.Message.getWrapperField(this, s2clientprotocol_common_pb.Size2DI, 1));
};
...
proto.SC2APIProtocol.StartRaw.prototype.getPathingGrid = function () {
    return /** @type{?proto.SC2APIProtocol.ImageData} */ (jspb.Message.getWrapperField(this, s2clientprotocol_common_pb.ImageData, 2));
};
...
proto.SC2APIProtocol.StartRaw.prototype.getTerrainHeight = function () {
    return /** @type{?proto.SC2APIProtocol.ImageData} */ (jspb.Message.getWrapperField(this, s2clientprotocol_common_pb.ImageData, 3));
};
/** @param {?proto.SC2APIProtocol.ImageData|undefined} value */
...
proto.SC2APIProtocol.StartRaw.prototype.getPlacementGrid = function () {
    return /** @type{?proto.SC2APIProtocol.ImageData} */ (jspb.Message.getWrapperField(this, s2clientprotocol_common_pb.ImageData, 4));
};
/** @param {?proto.SC2APIProtocol.ImageData|undefined} value */
...
proto.SC2APIProtocol.StartRaw.prototype.getPlayableArea = function () {
    return /** @type{?proto.SC2APIProtocol.RectangleI} */ (jspb.Message.getWrapperField(this, s2clientprotocol_common_pb.RectangleI, 5));
};
...
proto.SC2APIProtocol.StartRaw.prototype.getStartLocationsList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.Point2D>} */ (jspb.Message.getRepeatedWrapperField(this, s2clientprotocol_common_pb.Point2D, 6));
};
 ...
 * @const
 */
proto.SC2APIProtocol.ObservationRaw.repeatedFields_ = [2];
if (jspb.Message.GENERATE_TO_OBJECT) {
    /**
     * Creates an object representation of this proto suitable for use in Soy templates.
     * Field names that are reserved in JavaScript and will be renamed to pb_name.
    ...
    proto.SC2APIProtocol.ObservationRaw.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            unitsList: jspb.Message.toObjectList(msg.getUnitsList(), proto.SC2APIProtocol.Unit.toObject, includeInstance),
...
proto.SC2APIProtocol.ObservationRaw.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getPlayer();
    if (f != null) {
        writer.writeMessage(1, f, proto.SC2APIProtocol.PlayerRaw.serializeBinaryToWriter);
    }
    f = message.getUnitsList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(2, f, proto.SC2APIProtocol.Unit.serializeBinaryToWriter);
    }
    f = message.getMapState();
    if (f != null) {
        writer.writeMessage(3, f, proto.SC2APIProtocol.MapState.serializeBinaryToWriter);
    }
    f = message.getEvent();
    if (f != null) {
        writer.writeMessage(4, f, proto.SC2APIProtocol.Event.serializeBinaryToWriter);
    }
};
/**
...
proto.SC2APIProtocol.ObservationRaw.prototype.getPlayer = function () {
    return /** @type{?proto.SC2APIProtocol.PlayerRaw} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.PlayerRaw, 1));
};
...
proto.SC2APIProtocol.ObservationRaw.prototype.getUnitsList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.Unit>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.Unit, 2));
};
...
proto.SC2APIProtocol.ObservationRaw.prototype.getMapState = function () {
    return /** @type{?proto.SC2APIProtocol.MapState} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.MapState, 3));
};
...
proto.SC2APIProtocol.ObservationRaw.prototype.getEvent = function () {
    return /** @type{?proto.SC2APIProtocol.Event} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.Event, 4));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.SC2APIProtocol.PlayerRaw.toObject = function (includeInstance, msg) {
        var f, obj = {
            powerSourcesList: jspb.Message.toObjectList(msg.getPowerSourcesList(), proto.SC2APIProtocol.PowerSource.toObject, includeInstance),
...
proto.SC2APIProtocol.PlayerRaw.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.SC2APIProtocol.PowerSource.serializeBinaryToWriter);
    }
    f = message.getCamera();
    if (f != null) {
...
proto.SC2APIProtocol.PlayerRaw.prototype.getPowerSourcesList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.PowerSource>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.PowerSource, 1));
};
 ...
 * @const
 */
proto.SC2APIProtocol.Unit.repeatedFields_ = [22, 24, 27];
if (jspb.Message.GENERATE_TO_OBJECT) {
    /**
     * Creates an object representation of this proto suitable for use in Soy templates.
     * Field names that are reserved in JavaScript and will be renamed to pb_name.
    ...
    proto.SC2APIProtocol.Unit.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            ordersList: jspb.Message.toObjectList(msg.getOrdersList(), proto.SC2APIProtocol.UnitOrder.toObject, includeInstance),
            addOnTag: jspb.Message.getField(msg, 23),
            passengersList: jspb.Message.toObjectList(msg.getPassengersList(), proto.SC2APIProtocol.PassengerUnit.toObject, includeInstance),
...
proto.SC2APIProtocol.Unit.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getPos();
    if (f != null) {
        writer.writeMessage(6, f, s2clientprotocol_common_pb.Point.serializeBinaryToWriter);
    }
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(22, f, proto.SC2APIProtocol.UnitOrder.serializeBinaryToWriter);
    }
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(24, f, proto.SC2APIProtocol.PassengerUnit.serializeBinaryToWriter);
    }
    ...
    if (f.length > 0) {
        writer.writeRepeatedUint32(27, f);
    }
...
proto.SC2APIProtocol.Unit.prototype.getPos = function () {
    return /** @type{?proto.SC2APIProtocol.Point} */ (jspb.Message.getWrapperField(this, s2clientprotocol_common_pb.Point, 6));
};
/** @param {?proto.SC2APIProtocol.Point|undefined} value */
...
proto.SC2APIProtocol.Unit.prototype.getCloak = function () {
    return /** @type {!proto.SC2APIProtocol.CloakState} */ (jspb.Message.getFieldWithDefault(this, 10, 1));
};
...
proto.SC2APIProtocol.Unit.prototype.getOrdersList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.UnitOrder>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.UnitOrder, 22));
};
...
proto.SC2APIProtocol.Unit.prototype.getPassengersList = function () {
    return /** @type{!Array.<!proto.SC2APIProtocol.PassengerUnit>} */ (jspb.Message.getRepeatedWrapperField(this, proto.SC2APIProtocol.PassengerUnit, 24));
};
...
proto.SC2APIProtocol.MapState.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, s2clientprotocol_common_pb.ImageData.serializeBinaryToWriter);
    }
    f = message.getCreep();
    if (f != null) {
        writer.writeMessage(2, f, s2clientprotocol_common_pb.ImageData.serializeBinaryToWriter);
...
proto.SC2APIProtocol.MapState.prototype.getVisibility = function () {
    return /** @type{?proto.SC2APIProtocol.ImageData} */ (jspb.Message.getWrapperField(this, s2clientprotocol_common_pb.ImageData, 1));
};
/** @param {?proto.SC2APIProtocol.ImageData|undefined} value */
...
proto.SC2APIProtocol.ActionRaw.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, proto.SC2APIProtocol.ActionRawUnitCommand.serializeBinaryToWriter);
    }
    f = message.getCameraMove();
    if (f != null) {
        writer.writeMessage(2, f, proto.SC2APIProtocol.ActionRawCameraMove.serializeBinaryToWriter);
    }
    f = message.getToggleAutocast();
    if (f != null) {
        writer.writeMessage(3, f, proto.SC2APIProtocol.ActionRawToggleAutocast.serializeBinaryToWriter);
    }
};
/**
...
proto.SC2APIProtocol.ActionRaw.prototype.getUnitCommand = function () {
    return /** @type{?proto.SC2APIProtocol.ActionRawUnitCommand} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ActionRawUnitCommand, 1));
};
...
proto.SC2APIProtocol.ActionRaw.prototype.getCameraMove = function () {
    return /** @type{?proto.SC2APIProtocol.ActionRawCameraMove} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ActionRawCameraMove, 2));
};
...
proto.SC2APIProtocol.ActionRaw.prototype.getToggleAutocast = function () {
    return /** @type{?proto.SC2APIProtocol.ActionRawToggleAutocast} */ (jspb.Message.getWrapperField(this, proto.SC2APIProtocol.ActionRawToggleAutocast, 3));
};
...
proto.SC2APIProtocol.ActionRawUnitCommand.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getTargetWorldSpacePos();
    if (f != null) {
        writer.writeMessage(2, f, s2clientprotocol_common_pb.Point2D.serializeBinaryToWriter);
    }
    f = /** @type {number} */ (jspb.Message.getField(message, 3));
    if (f != null) {
        writer.writeUint64(3, f);
    ...
    if (f.length > 0) {
        writer.writeRepeatedUint64(4, f);
    }
...
proto.SC2APIProtocol.ActionRawUnitCommand.prototype.getTargetWorldSpacePos = function () {
    return /** @type{?proto.SC2APIProtocol.Point2D} */ (jspb.Message.getWrapperField(this, s2clientprotocol_common_pb.Point2D, 2));
};
...
proto.SC2APIProtocol.ActionRawToggleAutocast.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getUnitTagsList();
    if (f.length > 0) {
        writer.writeRepeatedUint64(2, f);
    }
};
/**
 * optional int32 ability_id = 1;
...
//# sourceMappingURL=raw_pb.js.map